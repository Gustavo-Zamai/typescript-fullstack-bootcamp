...
export const SignupCard = () => {
    ...
    return (
        ...
        <Box padding='3rem' 
            ...
            <InputCard id='confirmPassword' type='password' label='Confirm your password' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
            <LoginButton text='Signup' event={() => login(email, password)}/>
            <LinkComponent href='/' text="Already have an account? Login Here" />
        </Box>
        </Center>
    );
};